...
public interface RoomDao {
    @SqlUpdate("insert into room_sessions (session_id, game_started, " +
            ...
            "feature2, feature3, " +
            "num_players, player1_id, player2_id, player1_progress, player2_progress) " +
            "values (:session_id, :game_started, " +
            ":current_flag, :feature1, " +
            ":feature2, :feature3, " +
            ":num_players, :player1_id, :player2_id, :p1_progress, :p2_progress)")
    void insert(@Bind("session_id") int session_id, @Bind("game_started") boolean game_started,
                ...
                @Bind("p1_progress") int p1_progress, @Bind("p2_progress") int p2_progress);
